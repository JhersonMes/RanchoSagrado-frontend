...
export class ReservationComponent {
  ...
  protected readonly pageable = new PageableSearch<Reservation>(
    (page, size) => this.service.findAllPageable(page, size),
    () => this.$items(),
  );
  protected displayedColumns = ['idReservation', 'client', 'reservationDate', 'numberOfPeople', 'restaurantTable', 'status', 'actions'];
